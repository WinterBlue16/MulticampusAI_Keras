...
print(samsung.shape) # (2458,6) => (2451,)
print(kospi.shape) # (2458,6) => (2451,)
...
# print(x1_train.shape) # (1715, 7, 6)
# print(x1_test.shape) # (736, 7, 6)
# print(x2_train.shape) # (1715, 7, 6)
# print(x2_test.shape) # (736, 7, 6)
...
y_predict = model.predict([x1_test_scaled, x2_test_scaled], batch_size=10)
...
result = model.predict([x1_prd_scaled, x2_prd_scaled], batch_size=10)
print(result)
