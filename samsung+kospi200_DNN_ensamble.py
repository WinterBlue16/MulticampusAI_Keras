...
x1 = Dense(256)(input1) # 굳이 hidden layer의 이름을 다르게 지정해줄 필요가 없음 # summary를 확인하면 dense가 그대로 살아있는 것을 알 수 있다!
x1 = Dense(256)(x1)
...
x2 = Dense(256)(input2) # 굳이 hidden layer의 이름을 다르게 지정해줄 필요가 없음 # summary를 확인하면 dense가 그대로 살아있는 것을 알 수 있다!
x2 = Dense(256)(x2)
